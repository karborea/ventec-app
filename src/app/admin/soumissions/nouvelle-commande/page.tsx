...
import { createNouvelleCommandeAsAdmin } from "../proxy-actions";

export const metadata = {
  title: "Admin · Nouvelle commande · Ventec",
};
    ...
    <>
      ...
      <main className="w-full max-w-6xl mx-auto px-6 py-8 pb-20">
        <NouvelleCommandeForm
          action={createNouvelleCommandeAsAdmin}
